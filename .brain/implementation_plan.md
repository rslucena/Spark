...
1. Initialize a Tauri v2 project with a React + TypeScript frontend using Vite.
2. Configure Tailwind CSS and Framer Motion for styling and micro-interactions.
3. Set up the basic directory structure for the frontend (`src/components`, `src/hooks`, `src/pages`, etc.).
